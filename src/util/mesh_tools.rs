// taken from https://github.com/DGriffin91/bevy_mod_mesh_tools/blob/main/src/lib.rs
...
pub enum MeshAppendError {
    ...
    AttributeNotFound(MeshVertexAttribute),
}

pub fn mesh_append<'a>(dest_mesh: &'a mut Mesh, src_mesh: &'a Mesh) -> Result<(), MeshAppendError> {
