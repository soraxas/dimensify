use crate::{
    collision_checker::checker::{CollisionChecker, CollisionDetectorFromBevyRapierContext},
    robot::{RobotLinkIsColliding, urdf_loader::RobotLinkPart},
};
use bevy::{
    app::Update,
    color::Color,
...
use bevy_rapier3d::{pipeline::CollisionEvent, plugin::ReadDefaultRapierContext};
