...
use dimensify::{
    objects::node::{
        ColliderAsMeshSpawner, ColliderAsMeshSpawnerBuilder, EntitySpawner, EntitySpawnerArg,
    },
    BevyMaterial, Dimensify,
};
use rapier3d::prelude::*;

pub fn init_world(viewer: &mut Dimensify) {
    let mut g = viewer.graphics.as_mut().unwrap();

    g.graphics
        .pending_entity_spawners
        .push(Box::new(move |args: EntitySpawnerArg| {
